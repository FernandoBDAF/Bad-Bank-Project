...
export default function Home() {
  ...
  return (
    <div className="d-flex align-items-center justify-content-center bg-primary " style={{"height" : "50vh"}}>
        <div className="d-flex align-items-center justify-content-center" style={{"height" : "100%"}}>
          <img src="./bank.png" className="w-50" alt="Responsive image" />
        </div>
        <div className="d-flex flex-column align-items-start mt-4 pt-5" style={{"max-width" : "400px"}}>
          ...
          <p className="text-white-50">If you need help you can get a loan with us.</p>
      </div>
    </div>
  );
}